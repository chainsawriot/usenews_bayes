...
# cite Durkheim's book about suicide here or a reference discussing Durkheim's reserach
...
# add Hoekstra, R., Morey, R. D., Rouder, J. N., & Wagenmakers, E. J. (2014). Robust misinterpretation of confidence intervals. Psychonomic bulletin & review, 21(5), 1157-1164.
# add Morey, R. D., Hoekstra, R., Rouder, J. N., Lee, M. D., & Wagenmakers, E. J. (2016). The fallacy of placing confidence in confidence intervals. Psychonomic bulletin & review, 23(1), 103-123.
In our paper we first discuss these two issues before we suggest Bayesian multilevel regression as a standard approach for comparative research in journalism studies. While Bayesian models might be slightly more complicated to estimate in contrast to frequentist models as priors have to be chosen, these models allow researchers to make "principled statements about precision and plausibility" (Morey et al., 2016, p. 121) and solve the issue of misinterpreted confidence intervals (Hoeckstra et al., 2014; Rinke & Schneider, 2016). Using the openly available useNews data and the R package brms, we then demonstrate how to apply a Bayesian approach for the analysis of comparative content analysis.
